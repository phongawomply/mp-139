...
gulp.task('test:smoke', ['webdriver-update'], function() {
  return gulp.src(['../test/protractor/smoke/**/*spec.js'])
    .pipe(protractor({
      'configFile' : __dirname + '/../test/config/smoke.protractor.config.js'
    }))
